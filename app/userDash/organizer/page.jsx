                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <div className="flex-1 text-center md:text-left space-y-4">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                            <Button className="px-8 py-3  text-slate-950 hover:bg-primary-500 hover:text-white border-none text-[10px] font-black uppercase tracking-widest">
                                <FiPhone className="mr-2" /> Contact
                            </Button>
                            <Button
                                onClick={() => setShowChat(true)}
                                className="px-8 py-3 bg-white/10 text-white hover:bg-primary-600 border-none text-[10px] font-black uppercase tracking-widest"
                            >
