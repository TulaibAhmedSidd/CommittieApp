...
import { FiUsers, FiClock, FiCheckCircle, FiShield, FiStar, FiMessageSquare, FiX, FiInfo, FiExternalLink, FiMapPin } from "react-icons/fi";
...
export default function AssociationTransparency({ member }) {
    ...
    return (
        <div className="space-y-6">
            ...
            {selectedOrganizer && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-300 z-index-999">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-1">
                                                <h3 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter flex items-center gap-2">
                                                    {orgDetails?.name}
                                                    <BlueTick verified={orgDetails?.verificationStatus === 'verified'} size={16} />
                                                </h3>
                                                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">Organizer ID: {orgDetails?._id?.substring(selectedOrganizer?._id?.length - 8)}</p>
                                            </div>
                                        </div>
